    ...
    public partial class frmCrearAlumnos : Form
    {
        ...
        private void CargarDatos()
        {
            ...
            if (oListaAlumno.Count > 0)
            {
                ...
                tabla.Columns.Add("Documento Partida", typeof(string));
                ...
                {
                    tabla.Rows.Add(row.IdAlumno, row.Codigo, row.Nombres, row.Apellidos, row.DocumentoPartida, row.FechaNacimiento.Date.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture), 
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (dgvdata.SelectedRows.Count > 0)
            {
                ...
                txtdocumentoidentidad.Text = dgvdata.Rows[index].Cells["Documento Partida"].Value.ToString();
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            Alumno oAlumno = new Alumno()
            {
                ...
                DocumentoPartida = txtdocumentoidentidad.Text,
