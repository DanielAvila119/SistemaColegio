...
namespace Sistema
{
    public partial class frmRegistrarMatricula : Form
    {
        ...
        private void frmRegistrarMatricula_Load(object sender, EventArgs e)
        {
            ...
            cboestadocivil_apo.Items.Add(new ComboBoxItem() { Value = "Viudo(a)", Text = "Viudo(a)" });
        ...
        private void btnbuscar_Click(object sender, EventArgs e)
        {
            ...
            if (oObjecto != null)
            {
                ...
                if (oAlumno != null)
                {
                    ...
                    txtdocumentoidentidad_alu.Text = oAlumno.DocumentoPartida;
        ...
        {
            if (txtnombres_alu.Text == "" || txtapellidos_alu.Text == "" ||
        txtdocumentoidentidad_apo.Text == "" || txtnombres_apo.Text == "" || txtapellidos_apo.Text == "")
            ...
            xml.Add(new XElement("ALUMNO",
                        ...
                        // 🔹 aquí guardamos el idApoderado (lo tienes que resolver en el SP al registrar)
                        new XElement("idapoderado", "0") // si es nuevo apoderado irá en 0, tu SP debe devolver el ID generado
                        ));
            ...
            xml.Add(new XElement("APODERADO",
                        ...
                        new XElement("estadocivil", ((ComboBoxItem)cboestadocivil_apo.SelectedItem).Text.ToString()),
                        new XElement("ciudad", txtciudad_apo.Text),
                        new XElement("direccion", txtdireccion_apo.Text),
                        // aquí agregamos el teléfono
                        new XElement("numerotelefono", txttelefono_apo.Text)
                        ));
