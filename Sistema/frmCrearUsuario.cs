    ...
    public partial class frmCrearUsuario : Form
    {
        ...
        private void CargarDatos()
        {
            ...
            if (oListaUsuario.Count > 0)
            {
                ...
                dgvdata.Columns["Contraseña"].Visible = false;
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (eseditar)
            {
                //Validar duplicado en edición (excepto su propio ID)
                if (CD_Usuario.ExisteUsuario(oUsuario.LoginUsuario, oUsuario.IdUsuario))
                {
                    MessageBox.Show("El usuario ya existe. Intente con otro nombre.", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
            ...
            {
                //Validar duplicado en nuevo
                if (CD_Usuario.ExisteUsuario(oUsuario.LoginUsuario))
                {
                    MessageBox.Show("El usuario ya existe. Intente con otro nombre.", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
