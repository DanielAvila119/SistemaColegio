        ...
        private void BusquedaAlumno()
        {
            ...
            if (oListaAlumno != null)
            {
                ...
                if (oListaAlumno.Count > 0)
                {
                    ...
                    {
                        tabla.Rows.Add(row.IdAlumno, row.Codigo, row.Nombres, row.Apellidos, row.DocumentoPartida,
                    ...
                    {
                        if (cl.Visible == true && cl.Name != "btnSeleccionar") // Exclude "Seleccionar" column
                        {
            ...
            if (dgvdata.Columns[e.ColumnIndex].Name == "btnSeleccionar")
            {
                if (ModeloSeleccionado == Modelo.Alumno)
                {
                    Alumno oAlumno = new Alumno()
                    {
                        ...
                        DocumentoPartida = dgvdata.Rows[e.RowIndex].Cells["Documento Partida"].Value.ToString(),
